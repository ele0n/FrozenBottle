        ...
        for i in range(y):
            if(i%2 == 0):
                for j in range(x):
                    ...
                    pygame.draw.circle(self.screen,(0,0,0),(10*scale+j*20*scale,10*scale+i*17*scale),10*scale,0)
                    pygame.draw.circle(self.screen,(255,255,255),(10*scale+j*20*scale,10*scale+i*17*scale),8*scale,0)
            else:
                for j in range(x-1):
                    self.array[len(self.array)-1-((x-1-j)+x*i-(i+i%2)/2)] = (20*scale+j*20*scale,10*scale+i*17*scale)
                    pygame.draw.circle(self.screen,(0,0,0),(20*scale+j*20*scale,10*scale+i*17*scale),10*scale,0)
                    pygame.draw.circle(self.screen,(255,255,255),(20*scale+j*20*scale,10*scale+i*17*scale),8*scale,0)
